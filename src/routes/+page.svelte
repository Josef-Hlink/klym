...
<footer class="mx-auto max-w-3xl px-6 pb-10 text-center text-[11px] text-neutral-400">
	{#if __APP_COMMIT__ !== 'dev'}
		<a
			href="https://github.com/Josef-Hlink/klym/commit/{__APP_COMMIT__}"
			target="_blank"
			rel="noopener noreferrer"
			class="inline-flex items-center gap-1 align-middle hover:text-neutral-600"
		>
			...
			<span class="font-mono">{__APP_COMMIT__}</span>
		</a>
	{:else}
		<span class="font-mono">{__APP_COMMIT__}</span>
	{/if}
	· updated {__APP_UPDATED__}
</footer>
